...
export function mountAwards(athletes, stories, {f,pick,esc}) {
  ...
  async function drawMedal(a){
    ...
    c.textAlign='center';c.fillStyle='#9fab96';wrap(a.complete?f('40,27 км · полный маршрут · с остановками','40,27 км · цялото трасе · със спиранията'):f('Сокращённая дистанция. 1-я среди женщин, 5-я в общем — решение организатора.','Съкратена дистанция. 1-ва при жените, 5-а общо — решение на организатора.'),1222,19,920,27);
